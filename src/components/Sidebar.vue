    ...
    >
      <div class="flex items-center justify-center mt-8">
        <div class="flex items-center">
          <span class="mx-2 text-3xl font-semibold text-black">ELEV8</span>
          <svg
            class="w-12 h-12"
            viewBox="0 0 512 512"
            fill="none"
      ...
      <div class="flex items-center justify-center">
        <div class="flex items-center">
          <span class="mx-2 font-semibold text-black" style="font-size: 8px;">your key to seamless hospitality</span>
        </div>
      </div>
      

      <nav class="mt-10">
        <span class="mx-6">Main</span>

        <router-link
          class="flex items-center px-6 py-2 mt-1 duration-200"
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-1 duration-200"
          :class="[$route.name === 'Reservations' ? activeClass : inactiveClass]"
          to="/reservations"
        >
          <svg
            class="w-5 h-5"
          ...
          <span class="mx-4">Reservation</span>
        </router-link>
        ...
        <router-link
          class="flex items-center px-11 py-2 duration-200"
          :class="[$route.name === 'Forms' ? activeClass : inactiveClass]"
          to="/forms"
        >
          <span class="mx-4">Ongoing</span>
        </router-link>
        ...
        >
          ...
          <span class="mx-4">Upsells</span>
        </router-link>

        <br />
        <span class="mx-6">Extras</span>
        ...
        >
          ...
          <span class="mx-4">Inventories</span>
        </router-link>
